  ...
  <div class="min-h-screen md:h-screen md:overflow-hidden">
    ...
    <div class="relative md:h-full">
      ...
      <div class="flex w-full pt-18 md:h-full md:box-border md:gap-6 lg:gap-8 xl:gap-10">
        ...
        <div data-page-scroll-container class="flex-1 min-w-0 md:min-h-0 md:overflow-y-auto">
          <div class="w-full max-w-[1500px] mx-auto md:px-8 lg:px-12 xl:px-16">
            <main
              class="w-full md:max-w-[700px] lg:max-w-[760px] xl:max-w-[820px] 2xl:max-w-[900px] 3xl:ml-10 rounded-lg border border-white/60 bg-white/60 shadow-[0_24px_90px_-46px_rgba(31,41,55,0.8)] backdrop-blur-xl"
            >
              <router-view />
            </main>
          </div>
