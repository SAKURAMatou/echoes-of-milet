<template>
  ...
  >
    ...
    >
      ...
      <div
        class="mx-auto flex min-h-[calc(92svh-5rem)] w-full max-w-[1180px] items-end px-5 pb-10 pt-[42vh] sm:px-7 md:h-full md:min-h-0 md:items-center md:px-10 md:pb-0 md:pt-20 lg:px-8"
      >
        <div class="hero-copy-wash animate-fadein relative isolate w-full max-w-[640px]">
          ...
          <h1
            class="font-serif text-[clamp(3.1rem,7.8vw,6.4rem)] leading-[0.94] text-[#172b48] md:max-w-[720px]"
          >
            Where echoes
            <span class="block italic text-[#4e9ac5]">remain</span>
          </h1>
          <div
            class="mt-6 max-w-[590px] space-y-4 text-[0.95rem] leading-7 text-[#344b63] md:mt-5 md:space-y-3 md:text-base md:leading-8"
          >
